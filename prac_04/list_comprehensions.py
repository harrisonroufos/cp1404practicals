...
# last_names = []
names_longer_than_eleven = [name for name in full_names if len(name) > 11]
last_names = [name[name.find(" ") + 1:] for name in names_longer_than_eleven]
last_name_of_name_longer_than_eleven = ", ".join(last_names)
print(last_name_of_name_longer_than_eleven)
